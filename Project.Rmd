...
library(caTools)
library(ROCR)
#plot logistic regression, ROC = tpr vs fpr
lr_ROCRpred <- prediction(as.numeric(pred.value), class_prediction)
lr_ROCRperf <- performance(lr_ROCRpred, 'tpr', 'fpr')
plot(lr_ROCRperf, colorize=TRUE, text.adj = c(-0.2, 1.7), main="ROC Curve")
