...
#clean attributes
df_covid <- subset(df_covid_original, select = -c(Row.ID, Death.Rate...Cumulative, Death.Rate...Weekly, Deaths...Cumulative, Deaths...Weekly, Tests...Cumulative, Tests...Weekly, Test.Rate...Cumulative, Test.Rate...Weekly, Percent.Tested.Positive...Cumulative, Percent.Tested.Positive...Weekly))
...
df_covid$Week.End<-as.Date(df_covid$Week.End, format = "%m/%d/%Y")
